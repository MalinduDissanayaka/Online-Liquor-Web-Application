...
namespace LiquorOnline.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(LiquorOnlineContext context, IWebHostEnvironment webHost)
        {
            _context = context;
        ...
        //DHJFHJGJH
        public async Task<IActionResult> Create([Bind("ProductId,Productname,Brand,Description,Deliver,Quantity,ProductImage")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Productname,Brand,Description,Deliver,Quantity,ProductImage")] Product product)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            if (_context.Product == null)
            {
                return Problem("Entity set 'LiquorOnlineContext.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
